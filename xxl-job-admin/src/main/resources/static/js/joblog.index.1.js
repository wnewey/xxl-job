$(function() {
	...
	var logTable = $("#joblog_list").dataTable({
	    ...
	    "columns": [
          ...
          return '<a class="logTips" href="javascript:;" >' + row.jobId + '【' + row.executorHandler + '】' + '<span style="display:none;">' + temp + '</span></a>';
        }
      },
      {
        ...
        "render": function (data, type, row) {
          ...
          for (var index in $("#jobGroup").find("option")) {
            if ($(groupMenu[index]).attr('value') == data) {
              return $(groupMenu[index]).html() + '【' + (row.executorAddress || '') + "】";
            }
          }
          return data + ' ' + '【' + (row.executorAddress || '') + "】";
        }
      },
      {
        "data": 'triggerTime',
      ...
      },
      {
        ...
        "width": '10%',
        "render": function (data, type, row) {
          var code = row.triggerCode;
          var html = row.triggerCode;
          if (code == 200) {
            html = '<span style="color: green">【' + I18n.system_success + '】</span>';
          } else if (code == 500) {
            html = '<span style="color: red">【' + I18n.system_fail + '】</span>';
      ...
      },
      {
        ...
        "render": function (data, type, row) {
          ...
          if (row.executorFailRetryCount) {
            ...
            if (data) {
              html += "<span>下次重试时间:</span><br/>" + moment(new Date(data)).format("YYYY-MM-DD HH:mm:ss") + ""
            }
          }
          return html;
        }
    ...
    "language":
      {
        "sProcessing":
        I18n.dataTable_sProcessing,
        "sLengthMenu":
        I18n.dataTable_sLengthMenu,
        "sZeroRecords":
        I18n.dataTable_sZeroRecords,
        "sInfo":
        I18n.dataTable_sInfo,
        "sInfoEmpty":
        I18n.dataTable_sInfoEmpty,
        "sInfoFiltered":
        I18n.dataTable_sInfoFiltered,
        "sInfoPostFix":
          "",
        "sSearch":
        I18n.dataTable_sSearch,
        "sUrl":
          "",
        "sEmptyTable":
        I18n.dataTable_sEmptyTable,
        "sLoadingRecords":
        I18n.dataTable_sLoadingRecords,
        "sInfoThousands":
          ",",
        "oPaginate":
          {
            "sFirst":
            I18n.dataTable_sFirst,
            "sPrevious":
            I18n.dataTable_sPrevious,
            "sNext":
            I18n.dataTable_sNext,
            "sLast":
            I18n.dataTable_sLast
          }
        ,
        "oAria":
          {
            "sSortAscending":
            I18n.dataTable_sSortAscending,
            "sSortDescending":
            I18n.dataTable_sSortDescending
          }
      }
  });
